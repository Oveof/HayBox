/* Ultimate_WASD profile by Taker */
...
Ultimate_WASD::Ultimate_WASD(socd::SocdType socd_type) {
    _socd_pair_count = 4;
...
void Ultimate_WASD::UpdateDigitalOutputs(InputState &inputs, OutputState &outputs) {
    outputs.a = inputs.a;
    outputs.b = inputs.b;
    outputs.x = inputs.x;
    outputs.y = inputs.y;
...
void Ultimate_WASD::UpdateAnalogOutputs(InputState &inputs, OutputState &outputs) {
